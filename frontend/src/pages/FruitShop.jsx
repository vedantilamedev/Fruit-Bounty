          ...
          {products.map((product) => {
            ...
            return (
              <div
                ...
                className={`cursor-pointer w-72 rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 border ${
                  isSelected
              ...
              >
                ...
                <div className="relative bg-orange-50 p-4 flex justify-center items-center">
                  ...
                  <div className="absolute top-3 left-3 bg-yellow-400 text-white text-xs font-bold px-2 py-1 rounded-lg flex items-center gap-1">
                    ⭐ {product.rating || (Math.random() * 2 + 8).toFixed(1)}
                  </div>
                    ...
                    >
                     ...
                     <div className="relative inline-block">
                       <img
                         src={item.image}
                         alt={item.name}
                         className={`w-48 h-48 object-contain mx-auto transition duration-300 ${
                ...
                >
                  <div className="relative inline-block">
                    <img
                      src={item.image}
                      alt={item.name}
                      className={`w-40 h-40 object-contain mx-auto transition duration-300 ${
                        isSelected ? "scale-110" : "hover:scale-105"
                      }`}
                    />
