...
function Card({ className, ...props }) {
  return (
    <div
      className={cn("bg-white rounded-xl border", className)}
      {...props}
    />
  );
}
        ...
        <div className="space-y-4">
          {deliveries.map((delivery, index) => (
            <motion.div
              ...
              className="flex gap-4 p-4 rounded-xl bg-gray-50 border"
            >
        ...
        <div className="fixed inset-0 bg-black/40 flex justify-end">
          <div className="w-full sm:w-[400px] bg-white p-6 overflow-y-auto">
            ...
            <div className="space-y-3 text-sm">
              ...
              <p><b>Delivery Time:</b> {selected.time}</p>
              <p><b>Bowls:</b> {selected.bowls}</p>
