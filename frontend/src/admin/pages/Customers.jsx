...
function Button({ children, variant = "default", size = "default", className, ...props }) {
  ...
  return (
    <button className={cn("rounded-md font-medium", variants[variant], sizes[size], className)} {...props}>
      {children}
    </button>
  );
}
...
const customers = [
  ...
  },
  {
    ...
    address: "456 Market Avenue, San Francisco, CA",
    totalOrders: 12,
    totalSpent: 198.0,
    type: "Regular",
    joinDate: "2025-11-20",
  ...
  },
  {
    ...
    address: "321 Oak Lane, San Francisco, CA",
    totalOrders: 28,
    totalSpent: 462.0,
    type: "Regular",
    joinDate: "2025-09-10",
  },
  {
    ...
    address: "654 Pine Road, San Francisco, CA",
    totalOrders: 52,
    totalSpent: 961.0,
    type: "Subscriber",
    joinDate: "2025-07-22",
