...
export default function CustomizeBowl() {
    ...
    setFruits((prev) =>
      prev.map((f) =>
        f.id === id
          ? {
              ...f,
              type: f.type === "Free" ? "Premium" : "Free",
              price: f.type === "Free" ? 100 : 0,
            }
          : f
      )
    );
  ...
  const premiumFruits = fruits.filter(
    (f) => f.type === "Premium" && f.available
  );
    ...
    <div className="p-8">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <button
          ...
          className="bg-[#22c55e] text-white px-4 py-2 rounded-lg flex items-center gap-2 hover:bg-[#16a34a]"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <StatCard
          title="Free Fruits"
          value={fruits.filter((f) => f.type === "Free").length}
          color="text-green-600"
        />
        <StatCard
          title="Premium Fruits"
          value={fruits.filter((f) => f.type === "Premium").length}
          color="text-yellow-600"
        />
        <StatCard
          title="Available"
          value={fruits.filter((f) => f.available).length}
          color="text-blue-600"
        />
      </div>
              ...
              >
                ...
                <td className="text-center">
                  <button
                    ...
                    className="border border-red-400 text-red-600 p-2 rounded-lg hover:bg-red-50"
                  >
                    <Trash2 size={16} />
                  </button>
                </td>
      ...
      <div className="mt-8 bg-gradient-to-br from-green-50 to-yellow-50 p-6 rounded-2xl border">
          ...
          >
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <button
                  onClick={addFruit}
                  className="w-full bg-[#22c55e] text-white py-2 rounded-lg font-medium hover:bg-[#16a34a]"
                >
                  Add Fruit
                </button>
              </div>
