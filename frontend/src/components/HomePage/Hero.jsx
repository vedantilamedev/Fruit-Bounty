    ...
    <section className="w-full px-4 lg:px-6">
      ...
      <div className="hidden lg:block relative mx-auto w-[92%] max-w-6xl h-[620px] bg-white rounded-[32px] overflow-hidden shadow-2xl">
        ...
        />
            ...
            {/* SALADS */}
              <img src="/images/salad1.png" className="absolute w-[210px] top-[50px] right-[240px] float" />
              <img src="/images/salad2.png" className="absolute w-[210px] top-[180px] right-[80px] float" />
              <img src="/images/salad3.png" className="absolute w-[210px] bottom-[180px] right-[110px] float" />
              <img src="/images/salad4.png" className="absolute w-[210px] bottom-[50px] right-[260px] float" />
            </div>
      ...
      <div className="lg:hidden relative bg-[#efefef] rounded-[28px] flex flex-col items-center text-center px-5 pt-10 pb-16 overflow-hidden shadow-xl">
        ...
        />
          ...
          <h1 className="text-[38px] font-black text-[#b7aa6a] leading-none">YOUR</h1>
               <h2 className="text-[28px] italic text-[#b7aa6a] font-serif">Daily Dose</h2>
               <h3 className="text-[18px] font-extrabold text-[#b7aa6a] mb-6">OF FRESHNESS</h3>
